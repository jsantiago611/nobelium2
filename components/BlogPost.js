    ...
    <Link href={`${BLOG.path}/${post.slug}`}>
      <a>
        <article key={post.id} className="mb-6 md:mb-8">
          ...
          <main>
            <p className="text-xl md:text-2xl tracking-tight hidden md:block text-gray-500 dark:text-gray-300 font-mono font-light pb-8 border-solid border-gray-300 border-y">
              {post.summary}
            </p>
          </main>
        </article>
